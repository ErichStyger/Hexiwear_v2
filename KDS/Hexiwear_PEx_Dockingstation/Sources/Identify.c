...
static const ID_Device idTable[] =
{
  ...
  {.id=ID_DEVICE_HEXI_24,  .name=(const unsigned char*)"Hexi_23 00:2A:40:0B:00:4E", .uuid={{0x00,0x0D,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x4E,0x45,0x31,0x05,0x50,0x08,0x00,0x28}}},
