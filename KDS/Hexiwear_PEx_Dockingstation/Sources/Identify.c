...
static const ID_Device idTable[] =
{
  ...
  {.id=ID_DEVICE_HEXI_20,  .name=(const unsigned char*)"Hexi_20 00:4A:40:0A:00:41", .uuid={{0x00,0x23,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x4E,0x45,0x31,0x05,0x50,0x04,0x00,0x13}}},
  {.id=ID_DEVICE_HEXI_21,  .name=(const unsigned char*)"Hexi_21 00:34:40:0A:00:4E", .uuid={{0x00,0x34,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x4E,0x45,0x30,0x51,0x40,0x01,0x00,0x11}}}, /* problem lower half display? */
  {.id=ID_DEVICE_HEXI_22,  .name=(const unsigned char*)"Hexi_22 00:2D:40:0A:00:09", .uuid={{0x00,0x07,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x4E,0x45,0x31,0x05,0x50,0x04,0x00,0x21}}},
  {.id=ID_DEVICE_HEXI_23,  .name=(const unsigned char*)"Hexi_23 00:2A:40:0B:00:4E", .uuid={{0x00,0x0D,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x4E,0x45,0x31,0x05,0x50,0x08,0x00,0x28}}}, /* ghosting */
  ...
  {.id=ID_DEVICE_HEXI_25,  .name=(const unsigned char*)"Hexi_25 00:37:40:0B:00:02", .uuid={{0x00,0x0A,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x4E,0x45,0x31,0x05,0x50,0x04,0x00,0x08}}},
};
