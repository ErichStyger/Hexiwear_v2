...
uint8_t TSL2561_SetTiming(uint8_t timing) {
  return GI2C0_WriteByteAddress8(TSL2561_I2C_DEVICE_ADDRESS, TSL2561_COMMAND_BIT|TSL2561_REG_TIMING, timing);
}
