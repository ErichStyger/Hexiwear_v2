...
//          blocks.
// heap_3 â€? simply wraps the standard malloc() and free() for thread safety
// heap_4 - coalesces adjacent free blocks to avoid fragmentation. Includes
//          absolute address placement option
// heap_5 â€? as per heap_4, with the ability to span the heap across
//          multiple non-Â­â€?adjacent memory areas
